pipeline {
    ...
    stages {
        ...
        stage('Build') {
            ...
            steps {
                sh 'mvn clean install -f /var/jenkins_home/workspace/BuildApp/spring-boot/spring-boot-tests/spring-boot-smoke-tests/spring-boot-smoke-test-web-ui/pom.xml'
